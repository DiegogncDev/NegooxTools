...
class CategoriesCostsChartAdapter  (
    private var categories: List<String>,
    private var onChipClick: (String) -> Unit,
    private val dataStore: DataStore<Preferences>,
    context: Context
) : RecyclerView.Adapter<CategoriesCostsChartAdapter.CategoriesCostsChartViewHolder>() {
...
//        loadChecksCategories()
    ...
    inner class CategoriesCostsChartViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
...
//                saveIdAndQueryCategories()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoriesCostsChartViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_categories_product_chip, parent, false)
        return CategoriesCostsChartViewHolder(view)
    }

    override fun onBindViewHolder(holder: CategoriesCostsChartViewHolder, position: Int) {
