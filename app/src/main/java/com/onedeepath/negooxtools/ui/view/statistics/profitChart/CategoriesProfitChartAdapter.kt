package com.onedeepath.negooxtools.ui.view.statistics.profitChart
...
class CategoriesProfitChartAdapter(
private var categories: List<String>,
private var onChipClick: (String) -> Unit,
private val dataStore: DataStore<Preferences>,
context: Context
) : RecyclerView.Adapter<CategoriesProfitChartAdapter.CategoriesProfitChartViewHolder>() {
...
//        loadChecksCategories()
    ...
    inner class CategoriesProfitChartViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
...
//                saveIdAndQueryCategories()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoriesProfitChartViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_categories_product_chip, parent, false)
        return CategoriesProfitChartViewHolder(view)
    }

    override fun onBindViewHolder(holder: CategoriesProfitChartViewHolder, position: Int) {
