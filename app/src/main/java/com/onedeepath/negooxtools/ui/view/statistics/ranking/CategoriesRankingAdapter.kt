...
class CategoriesRankingAdapter (
private var categories: List<String>,
private var onChipClick: (String) -> Unit,
private val dataStore: DataStore<Preferences>,
context: Context) : RecyclerView.Adapter<CategoriesRankingAdapter.CategoriesRankingViewHolder>() {
...
//        loadChecksCategories()
    ...
    inner class CategoriesRankingViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
...
//                saveIdAndQueryCategories()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoriesRankingViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_categories_product_chip, parent, false)
        return CategoriesRankingViewHolder(view)
    }

    override fun onBindViewHolder(holder: CategoriesRankingViewHolder, position: Int) {
