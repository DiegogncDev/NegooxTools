...
import com.onedeepath.negooxtools.statistics.ranking.RankingActivity
...
class RankingTop3Adapter(private val criteriaItems: List<rankingTop3>,
    private val statisticsViewModel: StatisticsViewModel) : RecyclerView.Adapter<RankingTop3Adapter.RankingPrincipalViewHolder>(){
